...
//  myButtons.setSymbolFont(Dingbats1_XL);
  butskip = myButtons.addButton( 85,  220 , 70,  20, "Button 1");
  ...
  while (wait == 2) {
   ...
   if(myTouch.dataAvailable() == true)
   {
     ...
     // pressed_button = myButtons.checkButtons();
       Serial.println(F("I get here 2"));
       ///cout << F("Pressed button value ") << x << endl;
       // cout << F("Skip button value ") << y  << endl;
